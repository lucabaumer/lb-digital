...
const prozess = [
  ...
  { nr: "04", title: "Review & Optimierung", text: "Vor dem Launch testen wir Ihre Website auf allen Geräten und Browsern. Ladezeiten, SEO-Konfiguration, Lighthouse-Score und Barrierefreiheit — erst wenn alle Werte stimmen, gehen wir live." },
  { nr: "05", title: "Launch & Support", text: "Deployment, Domain-Konfiguration, SSL-Zertifikat und Sitemap-Einreichung bei Google — alles aus einer Hand. Nach dem Launch stehen wir für Fragen und Anpassungen bereit." },
];
...
const faqData = [
  ...
  { q: "Ist meine Website auch auf dem Smartphone optimiert?", a: "Ja — wir arbeiten nach dem Mobile First-Prinzip. Die mobile Version wird zuerst gestaltet, dann für Tablet und Desktop erweitert. Über 70 % aller Website-Besucher kommen heute vom Smartphone. Google bewertet Websites primär nach ihrer mobilen Version (Mobile First Indexing). Eine nicht-mobile-optimierte Website verliert messbar Ranking-Punkte." },
  ...
  { q: "Wie unterscheidet sich LB Digital von anderen Webdesign-Agenturen?", a: "Die meisten Agenturen arbeiten mit WordPress-Templates oder veralteten Technologien. LB Digital entwickelt ausschließlich mit Next.js und React. Sie arbeiten direkt mit dem Entwickler zusammen — kein Mittelsmann, kein Projektmanager-Filter. Schnellere Kommunikation, weniger Missverständnisse und ein Endprodukt, das wirklich Ihren Anforderungen entspricht." },
  { q: "Was brauche ich um zu starten?", a: "Für den Start benötigen wir: eine grobe Vorstellung, was die Website leisten soll (Ziele, Zielgruppe), vorhandene Markenmaterialien wie Logo, Farben oder Fonts (falls vorhanden), und Stichpunkte zu Ihren Leistungen. Haben Sie noch kein Logo oder kein klares Branding? Kein Problem — wir können auch dabei helfen." },
  { q: "Bieten Sie Wartung und Support nach dem Launch an?", a: "Ja. Nach dem Launch stehen wir für technischen Support, Inhaltsaktualisierungen und Anpassungen bereit. Wir bieten flexible Support-Pakete an — von der reinen Bereitschaft für Notfälle bis hin zu regelmäßiger Betreuung mit monatlichen Updates und Performance-Monitoring." },
  { q: "Was ist ein Lighthouse Score und warum ist er wichtig?", a: "Google Lighthouse bewertet Websites in vier Kategorien: Performance (Ladegeschwindigkeit), Accessibility (Barrierefreiheit), Best Practices (Sicherheit und Code-Qualität) und SEO. Scores gehen von 0 bis 100. Websites mit niedrigen Performance-Scores werden von Google schlechter eingestuft, da Nutzererfahrung ein direkter Rankingfaktor ist. Unsere Websites erreichen 95+ in allen Kategorien." },
  { q: "Was ist der Unterschied zwischen einer Landingpage und einer Business-Website?", a: "Eine Landingpage ist eine einzelne, fokussierte Seite mit einem klaren Ziel — z.B. Kontaktanfragen. Sie eignet sich als erste Online-Präsenz oder für Kampagnen. Eine Business-Website umfasst mehrere Unterseiten (Startseite, Leistungen, Über uns, Kontakt) und bietet Besuchern ein vollständiges Bild Ihres Unternehmens. Für die meisten Unternehmen in Furtwangen ist eine Business-Website die richtige Wahl." },
  { q: "Wie wirkt sich die Website-Geschwindigkeit auf mein Google-Ranking aus?", a: "Seit 2021 sind die Core Web Vitals offizieller Rankingfaktor bei Google. Websites, die diese Werte nicht erfüllen, werden systematisch schlechter eingestuft. Eine Website mit 3 Sekunden Ladezeit hat gegenüber einer Website mit unter 1 Sekunde einen messbaren Ranking-Nachteil — unabhängig vom Inhalt. Schnelle Websites gewinnen in der organischen Suche." },
...
export default function WebdesignFurtwangenContent() {
  ...
  return (
    <>
      ...
      {/* ── Hero ─────────────────────────────────────────────────────────── */}
      <section ref={heroRef} aria-labelledby="fw-heading" className="relative flex items-center overflow-hidden" style={{ background: BG, minHeight: "100dvh" }}>
        <motion.div aria-hidden="true" className="absolute inset-0 pointer-events-none" style={{ y: glowY }}>
          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 60% 55% at 80% 45%, rgba(18,100,241,0.16) 0%, transparent 65%)" }} />
          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 45% 40% at 15% 65%, rgba(18,100,241,0.09) 0%, transparent 60%)" }} />
        </motion.div>
        ...
        <motion.div className="container-xl relative z-10 w-full" style={{ opacity: contentOpacity, y: contentY }}>
          <div className="pt-32 pb-20 md:pt-40 md:pb-28 max-w-3xl">
            <motion.nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-6" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 }}>
              ...
              <span className="text-xs" style={{ color: "rgba(255,255,255,0.5)" }}>Webdesign Furtwangen</span>
            </motion.nav>

            <motion.p className="eyebrow mb-5" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.1 }}>
              Webdesign · Furtwangen im Schwarzwald
            </motion.p>

            <motion.h1 id="fw-heading" className="font-display font-extrabold leading-[1.04] tracking-tight text-white mb-6" style={{ fontSize: "clamp(38px, 6vw, 80px)" }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75, delay: 0.18, ease: EASE }}>
              Webdesign für den{" "}
              <span style={{ color: ACCENT }}>Schwarzwald</span>
        ...
        <div className="container-xl py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <Reveal>
              ...
              <h2 id="furtwangen-heading" className="font-display font-extrabold text-white leading-tight mb-6" style={{ fontSize: "clamp(26px, 3.5vw, 48px)" }}>
                Webdesign, das den Hochschwarzwald kennt
              </h2>
              <div className="space-y-4" style={{ color: "rgba(255,255,255,0.62)", fontSize: "clamp(14px, 1.5vw, 16px)", lineHeight: "1.75" }}>
                <p>
                  Furtwangen im Schwarzwald ist mehr als ein Ort im Hochschwarzwald. Mit der Hochschule Furtwangen University (HFU) — einer der bedeutendsten Hochschulen für Technik, Informatik und Wirtschaft in Baden-Württemberg — ist Furtwangen ein Bildungs- und Innovationsstandort mit überregionaler Bedeutung.
                </p>
                <p>
                  Die Region ist bekannt für Präzisionsfertigung, Medizintechnik, Tourismus und einen starken Mittelstand. Das Deutsches Uhrenmuseum zieht Besucher aus aller Welt an. Die Nähe zu Triberg, Villingen-Schwenningen und dem gesamten Hochschwarzwald macht Furtwangen zu einem attraktiven Wirtschaftsstandort.
                </p>
                <p>
                  Als Webdesign-Agentur aus der Region verstehen wir, wie lokale Kunden suchen und was sie von einer professionellen Website erwarten. Ob Handwerksbetrieb, Gastronomie, Dienstleister oder HFU-Startup — wir bauen Websites, die lokal gefunden werden und regional überzeugen.
                </p>
              </div>
            </Reveal>
            ...
            <StaggerReveal className="grid grid-cols-2 gap-4">
              {[
                { value: "5.000+", label: "HFU Studierende" },
                { value: "50km", label: "Entfernung Freiburg" },
      ...
      <section aria-labelledby="tech-heading" style={{ background: BG }}>
        <div className="container-xl py-24 md:py-32">
          ...
          <StaggerReveal className="grid md:grid-cols-3 gap-6">
            {[{ title: "Geschwindigkeit als Rankingfaktor", text: "Google bewertet Ladegeschwindigkeit über die Core Web Vitals. WordPress erreicht oft 3–8 Sekunden. Unsere Next.js-Websites laden in unter einer Sekunde — ein direkter Vorteil für Ihr Ranking, auch in Furtwangen." }, { title: "Kein WordPress, kein Sicherheitsproblem", text: "WordPress ist das meistgehackte CMS der Welt. Next.js hat keine Plugins, keine Datenbank-Angriffsfläche. Ihre Website wird als statische Dateien ausgeliefert — technisch nahezu unangreifbar." }, { title: "Vercel Edge Network", text: "Wir hosten auf Vercel, dem globalen Edge-Network. Ihre Website wird vom nächstgelegenen Rechenzentrum ausgeliefert — egal ob Ihr Besucher in Furtwangen, Villingen oder weltweit ist." }].map((item) => (
              <motion.div key={item.title} variants={fadeUp} className="p-6 rounded-lg" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
      ...
      <section aria-labelledby="preise-heading" style={{ background: BG }}>
        <div className="container-xl py-24 md:py-32">
          ...
          <StaggerReveal className="grid md:grid-cols-3 gap-6">
            {[{ name: "Landingpage", price: "ab 1.000 €", desc: "Einzelne, fokussierte Seite mit klarem Ziel. Ideal als erste Online-Präsenz oder für gezielte Kampagnen.", features: ["1 Seite, vollständig responsive", "Kontaktformular", "SEO-Grundoptimierung", "Lighthouse 95+", "Deployment auf Vercel"], cta: "Landingpage anfragen", highlight: false }, { name: "Business-Website", price: "3.000–6.000 €", desc: "Vollständige Website mit mehreren Unterseiten. Das richtige Fundament für Ihr Unternehmen.", features: ["Startseite + Unterseiten", "Individuelles Design-System", "Vollständiges SEO-Setup", "Schema-Markup (JSON-LD)", "Headless CMS optional"], cta: "Business-Website anfragen", highlight: true }, { name: "Individualprojekt", price: "Auf Anfrage", desc: "Komplexe Anforderungen oder besondere Funktionen? Wir machen ein individuelles Angebot.", features: ["Individuelle Architektur", "API-Integrationen", "E-Commerce / Portale", "Laufende Betreuung", "SLA nach Vereinbarung"], cta: "Projekt besprechen", highlight: false }].map((plan) => (
        ...
        <div className="container-xl py-24 md:py-32">
          <Reveal className="mb-16">
            ...
            <h2 id="faq-heading" className="font-display font-extrabold text-white leading-tight" style={{ fontSize: "clamp(28px, 4vw, 52px)" }}>
              Häufige Fragen zu Webdesign in Furtwangen
            </h2>
          </Reveal>
          <StaggerReveal>
        ...
        <div className="container-xl py-16">
          <Reveal>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/seo-freiburg" className="group flex items-center gap-2 text-sm font-medium" style={{ color: "rgba(255,255,255,0.6)" }}>
                <span className="group-hover:translate-x-1 transition-transform" style={{ color: ACCENT }}>→</span>
        ...
        <div className="container-xl py-24 md:py-32 text-center">
          <Reveal>
            ...
            <h2 id="cta-heading" className="font-display font-extrabold text-white leading-tight mb-6 mx-auto" style={{ fontSize: "clamp(30px, 5vw, 64px)", maxWidth: "640px" }}>
              Ihr Unternehmen in Furtwangen verdient eine Website, die wirkt.
            </h2>
