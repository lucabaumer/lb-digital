...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/handwerker`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/webdesign-furtwangen`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    // Referenzprojekte
